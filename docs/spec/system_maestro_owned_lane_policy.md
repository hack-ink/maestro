...
- Local files such as `AGENTS.md` and the installed workflow skills are execution-context inputs for a compliant Maestro implementation. They are not the core domain model of this policy.
